...
namespace fgl
{
	...
	public:
		...
		static ArrayList<CollisionRect*> fromFrame(TransformState state, TransformState prevState, const ArrayList<CollisionRect*>& prevRects, Vector2d size, Vector2d origin, Vector2d resolution=Vector2d(1.0,1.0));
		...
		static ArrayList<CollisionRect*> fromAnimation(TransformState state, TransformState prevState, const ArrayList<CollisionRect*>& prevRects, Vector2d size, Vector2d origin, Animation* animation, size_t frameIndex, bool mirroredHorizontal=false, bool mirroredVertical=false);
